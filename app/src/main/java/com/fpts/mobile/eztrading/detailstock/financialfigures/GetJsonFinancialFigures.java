...
public class GetJsonFinancialFigures {
    ...
    private static ArrayList<String> getDataPrivate(Context context, String code) {
        ...
        ArrayList<String> cache = DataFinancialFigures.getCache(context, code);

        String get = new HttpHandler().makeServiceCall(DataFinancialFigures.getLinkJson(code));
        if (get == null)
            return cache;
            ...
            if (jsonArray != null && jsonArray.length() > 0) {
                for (int i = 0; i < jsonArray.length() - 1; i++) {
                    ...
                    if (object.getString("TITLE") != null &&
                        ...
                        arrayList.add(object.getString("RATIO1"));
//                    arrayList.add(object.getString("CpnyType"));
                    }
                }
                arrayList.add(((JSONObject) jsonArray.get(jsonArray.length() - 1)).getString("Period"));
            }
