...
public class DataChart {
    ...
    public DataChart(Context context, ArrayList<HistoryChartOtherIndex> yVals1, ChartFragment chartFragment) {
    ...
    public void loadDt(String code, final int sizedate, final String key, final int p1, final int p2, final int p3) {
        ...
        new Thread(() -> {
            List<HistoryChartOtherIndex> list = GetJsonChart.loadDataAll(ValueApp.contextChart, code);
            yVals1 = list;
            if (!yVals1.isEmpty()) {
...
//            view.showChart(top1, mid1, bot1, ema1, sma1, sma12, listRsi1, yVals11, getMacd(yVals11, p1, p2, p3), key, p1, p2, p3);
            switch (key) {
                case VOLUMN:
                    ...
                    ValueApp.activityChart.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            chartFragment.showChart1(yVals11);
                        }
                    });
...
//                    view.showChart(yVals11);
                ...
                case MACD:
                    ...
                    ValueApp.activityChart.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            chartFragment.showChart2(yVals11, getMacd(yVals11, p1, p2, p3));
                        }
                    });
                ...
                case RSI:
                    ...
                    double[] finalListRsi = listRsi1;
                    ValueApp.activityChart.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            chartFragment.showChart3(yVals11, sma1, sma12, finalListRsi, key, p1, p3);
                        }
                    });
                ...
                case BOLINGER_BAND:
                    ...
                    ValueApp.activityChart.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            chartFragment.showChart4(top1, mid1, bot1, ema1, yVals11, key);
                        }
                    });
                ...
                case STOCHASTICS:
                    ...
                    double[] finalListRsi1 = listRsi1;
                    ValueApp.activityChart.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            chartFragment.showChart3(yVals11, sma1, sma12, finalListRsi1, key, p1, p3);
                        }
                    });
                    break;
            }
